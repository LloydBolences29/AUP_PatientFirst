  ...
  const handleSearch = async () => {
    try {
      const response = await axios.get(
        `https://aup-patientfirst-server.onrender.com/billing/billing/search?query=${searchQuery}`
      );
  ...
  const handlePayment = async () => {
    try {
      ...
      for (const bill of billingDetails) {
        await axios.put(`https://aup-patientfirst-server.onrender.com/billing/update/${bill._id}`, {
