...
const PatientProfile = () => {
  ...
  useEffect(() => {
    const fetchPatientId = async () => {
      try {
        const response = await axios.get("https://aup-patient-first.vercel.app//patientname/auth/me", {
  ...
  useEffect(() => {
    const fetchPatientVisits = async () => {
      try {
        ...
        const response = await axios.get(`https://aup-patient-first.vercel.app//patient-visit/fetchVisit/${patient._id}`);
