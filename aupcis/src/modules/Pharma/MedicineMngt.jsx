...
const MedicineMngt = () => {
      ...
      const medicinesWithQuantities = await Promise.all(
        response.data.medicines.map(async (medicine) => {
          const batchResponse = await axios.get(
            "https://aup-patient-first.vercel.app//api/pharma/getStock"
          );
  ...
  const handleAddStock = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://aup-patient-first.vercel.app//api/pharma/add-stock",
        stockPayload
      );
  ...
  const handleAddMedicine = async (e) => {
    ...
    try {
      ...
      await axios.post(
        "https://aup-patient-first.vercel.app//api/pharma/add-medicines",
        formData
      );
  ...
  const handleUpdateMedicine = async (e) => {
    ...
    try {
      ...
      await axios.put(
        `https://aup-patient-first.vercel.app//api/pharma/update-medicine/${formData._id}`,
        formData
      );
